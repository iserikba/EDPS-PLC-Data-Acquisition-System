========================================================================
    ACTIVE TEMPLATE LIBRARY : EdpsUtils Project Overview
========================================================================

AppWizard has created this EdpsUtils project for you to use as the starting point for
...
_EdpsUtils.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_EdpsUtils.h)
        GUID definitions                                (_EdpsUtils_i.c)
        A type library                                  (_EdpsUtils.tlb)
        Marshaling code                                 (_EdpsUtils_p.c and dlldata.c)
EdpsUtils.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named EdpsUtils.pch and a precompiled types file named StdAfx.obj.
...
EdpsUtilsps.vcproj
	...
	dlldata.c, EdpsUtils_i.c and EdpsUtils_p.c which are required
